...
const { Animation, Color, Command, Frame, Rect, Scene, Sprite, Transition, Videogame } = videogame;
const { BaseTile, FontSprite, JumperSprite } = videogame.plugin;
...
class IntroScene extends Scene {
	...
	update() {
		...
		if (this.tick == 1) {
			...
			this.text.expire();
			this.text = new FontSprite("...there was a princess and her dog friend.");
			this.text.setCenter(this.center);
			this.add(this.text);
		} else if (this.tick == 200) {
			Videogame.playTheme("theme1");
			this.text.expire();
			...
			this.dog.expire();
			this.princess.expire();
			this.text = new FontSprite("eventually, the dog became sick...");
			this.text.setCenter(this.center);
			this.add(this.text);
		} else if (this.tick == 700) {
			this.text.expire();
			this.text = new FontSprite("...and soon passed away...");
			this.text.setCenter(this.center);
			this.add(this.text);
		} else if (this.tick == 800) {
			this.text.expire();
			this.text = new FontSprite("...leaving a very sad princess alone.");
			this.text.setCenter(this.center);
			this.add(this.text);
			...
			this.dog.expire();
			this.princess.expire();
			this.text = new FontSprite("it took a while, until she managed to carry on...");
			this.text.setCenter(this.center);
			this.add(this.text);
		} else if (this.tick == 1100) {
			this.text.expire();
			this.text = new FontSprite("...but she never forgot her beloved friend.");
			this.text.setCenter(this.center);
			this.add(this.text);
			...
			this.dog.setRight(this.princess.left);
			this.add(this.dog);
		} else if (this.tick == 1300) {
			this.dog.expire();
			this.princess.expire();
			this.text = new FontSprite("one night, many years later...");
			this.text.setCenter(this.center);
			this.add(this.text);
		} else if (this.tick == 1400) {
			this.text.expire();
			this.text = new FontSprite("...evil demons tried to take over the pricess' castle...");
			this.text.setCenter(this.center);
			this.add(this.text);
		} else if (this.tick == 1500) {
			this.text.expire();
			this.text = new FontSprite("...but they didn't expect one more spirit to return.");
			this.text.setCenter(this.center);
			this.add(this.text);
		} else if (this.tick == 1600) {
			this.text.expire();
			this.dog = new Sprite();
			this.dog.setImage("cross");
			this.dog.setBottom(this.tile.top - 1);
...
class Player extends JumperSprite {
	constructor(scene) {
		...
		this.animations = {
			left: new Animation([
				new Frame(Videogame.image("player0", true), 4),
				new Frame(Videogame.image("player1", true), 4),
				new Frame(Videogame.image("player0", true), 4),
				new Frame(Videogame.image("player1", true), 4),
				new Frame(Videogame.image("player0", true), 4),
				new Frame(Videogame.image("player1", true), 4),
				new Frame(Videogame.image("player0", true), 4),
				new Frame(Videogame.image("player1", true), 4),
				new Frame(Videogame.image("player2", true), 4),
				new Frame(Videogame.image("player1", true), 4),
			]),

			right: new Animation([
				new Frame(Videogame.image("player0"), 4),
				new Frame(Videogame.image("player1"), 4),
				new Frame(Videogame.image("player0"), 4),
				new Frame(Videogame.image("player1"), 4),
				new Frame(Videogame.image("player0"), 4),
				new Frame(Videogame.image("player1"), 4),
				new Frame(Videogame.image("player0"), 4),
				new Frame(Videogame.image("player1"), 4),
				new Frame(Videogame.image("player2"), 4),
				new Frame(Videogame.image("player1"), 4),
			]),

			walk: {
				left: new Animation([
					new Frame(Videogame.image("playerWalk", true), 4),
					new Frame(Videogame.image("player0", true), 4),
				]),

				right: new Animation([
					new Frame(Videogame.image("playerWalk"), 4),
					new Frame(Videogame.image("player0"), 4),
				])
			},
		};
	...
	die() {
		...
		if (this.isRight) {
			this.setImage(Videogame.image("player2"));
		} else {
			this.setImage(Videogame.image("player2", true));
		}

		this.setImage(Videogame.flip(this.image));
		this.setSpeedY(this.jumpSpeed);
		Videogame.setFrameTime(80);
	}
	...
	onJump() {
		...
		if (this.isRight) {
			this.setImage(Videogame.image("playerWalk"));
		} else {
			this.setImage(Videogame.image("playerWalk", true));
		}
	}
...
class Skull extends Jumpable {
	constructor() {
		...
		this.animations = {
			left: new Animation([
				new Frame(Videogame.image("skull0"), 6),
				new Frame(Videogame.image("skull1"), 6)
			]),

			right: new Animation([
				new Frame(Videogame.image("skull0", true), 6),
				new Frame(Videogame.image("skull1", true), 6)
			])
		};
...
class Ghost extends Jumpable {
	constructor() {
		...
		this.animations = {
			left: new Animation([
				new Frame(Videogame.image("ghost0"), 4),
				new Frame(Videogame.image("ghost1"), 4),
				new Frame(Videogame.image("ghost2"), 4),
				new Frame(Videogame.image("ghost3"), 4),
				new Frame(Videogame.image("ghost4"), 4),
				new Frame(Videogame.image("ghost5"), 4),
				new Frame(Videogame.image("ghost6"), 4)
			]),

			right: new Animation([
				new Frame(Videogame.image("ghost0", true), 4),
				new Frame(Videogame.image("ghost1", true), 4),
				new Frame(Videogame.image("ghost2", true), 4),
				new Frame(Videogame.image("ghost3", true), 4),
				new Frame(Videogame.image("ghost4", true), 4),
				new Frame(Videogame.image("ghost5", true), 4),
				new Frame(Videogame.image("ghost6", true), 4)
			])
		};
...
Videogame.setName("Alpha");
Videogame.init(new IntroScene);
